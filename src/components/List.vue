...
<script>
  import CellTips from '../../vuwe/src/components/cells/cells-tips.vue'
  import Cell from '../../vuwe/src/components/cells/cell.vue'
  import ListItem from '../../vuwe/src/components/list/list-item.vue'
  export default {
    components: {
      CellTips,
      Cell,
